        ...
        <section className="overflow-y-scroll w-full h-full">
          ...
          <main className="mt-8 w-full flex justify-center items-center flex-col">
            <section className="w-full flex justify-center items-center">
              <article className="relative w-1/6 h-1/6">
                <img
                  className="rounded-md"
                  src={user.avatarImage ?? '/images/user.png'}
                  alt="user-avatar"
                />
                <button className="bg-white rounded-full absolute bottom-1 right-1 cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-8 w-8"
                    fill="none"
